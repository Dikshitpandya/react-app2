    ...
    return (<aside id = "layout-menu" className = "layout-menu menu-vertical menu bg-menu-theme" >
      ...
      <ul className="menu-inner py-1">
        <li className="menu-item">
          <a href="admin-home.html" className="menu-link">
            <i className="menu-icon tf-icons bx bx-home-circle" />
            <div data-i18n="Analytics">Home</div>
          </a>
        </li>
        <li className="menu-item">
          <a href="admin-category.html" className="menu-link">
            <i className="menu-icon bx bxs-category" />
            <div data-i18n="Analytics">Category</div>
          </a>
        </li>
        <li className="menu-item">
          <a href="admin-product.html" className="menu-link">
            <i className="menu-icon bx bxs-gift" />
            <div data-i18n="Analytics">Products</div>
          </a>
        </li>
        <li className="menu-item">
          <a href="admin-orders.html" className="menu-link">
            <i className="menu-icon bx bxs-cart-alt" />
            <div data-i18n="Analytics">Orders</div>
          </a>
        </li>
        <li className="menu-item">
          <a href="admin-users.html" className="menu-link">
            <i className="menu-icon bx bxs-user" />
            <div data-i18n="Analytics">Users</div>
          </a>
        </li>
        <li className="menu-item">
          <a href="admin-change-password.html" className="menu-link">
            <i className="menu-icon bx bxs-category" />
            <div data-i18n="Analytics">Change Password</div>
          </a>
        </li>
        <li className="menu-item">
          <a href="admin-logout.html" className="menu-link">
